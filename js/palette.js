...
! function () {
  var e = {
    ...
    init() {
      ...
      this.setActiveButton(appJSON.palette), 
      this.generateTheme(appJSON.palette)
    },
    generateButtons() {
      let e = "",
          a = "";
      ...
      var f = document.createElement("FIGURE"),
          f = (
            f.innerHTML = e, 
            document.querySelector(this.selectorSection).prepend(f), 
    ...
    generateTheme(e) {
      ...
      let f = {
        ...
        ".c600": e[600],
        ".c700": e[700],
        ".c600-outline-light": this.hexToRgbA(e[600], .125),
        ".c600-outline-dark": this.hexToRgbA(e[600], .25),
        ".inverse": e.inverse
      };
    ...
    @media only screen and (prefers-color-scheme: dark) {
      :root:not([data-theme="light"]) [data-generatedtheme="generated"] {
        --h4-color: ${e[400]};
        --primary: ${e[600]};
        --primary-hover: ${e[500]};
    ...
    [data-theme="dark"] [data-generatedtheme="generated"] {
      --h4-color: ${e[500]};
      --primary: ${e[600]};
      --primary-hover: ${e[500]};
      --primary-focus: ${this.hexToRgbA(e[600],.25)};
